...
WHITE, BLACK, RED, GREEN, GOLD, BLUE, DARK_GRAY = (255, 255, 255), (0, 0, 0), (255, 0, 0), (0, 255, 0), (255, 215, 0), (0, 100, 255), (40, 40, 40)
...
def main(high_score):
    ...
    while running:
        ...
        if not special_item["pos"] and random.random() < 0.01:
            special_item["pos"] = [random.randrange(0, GAME_WIDTH, BLOCK_SIZE), random.randrange(0, GAME_HEIGHT, BLOCK_SIZE)]
        ...
        if new_head in snake_body:
            ...
            if new_head[0] == food_x and new_head[1] == food_y:
                score += 1
                food_x, food_y = random.randrange(0, GAME_WIDTH, BLOCK_SIZE), random.randrange(0, GAME_HEIGHT, BLOCK_SIZE)
            
            # Eating Special Item
            elif special_item["pos"] and new_head[0] == special_item["pos"][0] and new_head[1] == special_item["pos"][1]:
        ...
        # Draw Special Item
        if special_item["pos"]:
            color = GOLD if special_item["type"] == "gold" else (BLUE if special_item["type"] == "slow" else (255, 0, 255))
